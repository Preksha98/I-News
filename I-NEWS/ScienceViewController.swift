...
class ScienceViewController: UIViewController , UITableViewDataSource , UITableViewDelegate {
    var t = [Int]()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "sciencecell") as! ScienceTableViewCell
        cell.sclbl.text = ti[indexPath.row]
        ...
        if data != nil
        {
            cell.scimg.image =  UIImage(data:data as! Data)
        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "sccon", sender: nil)
        
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let vc = segue.destination as! SciencecontentViewController
        vc.ts = cont
        
        
    }

    @IBOutlet weak var science: UITableView!
...
POST_Data()
    ...
    {
        //Make ADDRESS URL
        let reqUrl = URL(string: "https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=68837ddffe7343d69a232fba9e7fc178")
