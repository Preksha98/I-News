...
class SportsViewController: UIViewController , UITableViewDelegate , UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       var cell = tableView.dequeueReusableCell(withIdentifier: "sportscell") as! SportsTableViewCell
        cell.stxt.text = ti[indexPath.row]
//        cell.simg.image = UIImage(named: (ti[indexPath.row] + ".jpg"))
        ...
        if data != nil
        {
            cell.simg.image =  UIImage(data:data as! Data)
        }
...
//        let vc = segue.destination as! SportscontentViewController
//        vc.tp = con
//
//
//    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        con = c[indexPath.row]
        print(con)
        performSegue(withIdentifier: "sportscontent", sender: nil)
    }
    ...
    {
        //Make ADDRESS URL
        let reqUrl = URL(string: "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=8cfb95a718884523be0b578d54100119")
