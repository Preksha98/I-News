...
class TechnologyViewController: UIViewController , UITableViewDataSource ,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "technologycell") as! TechnologyTableViewCell
        cell.tlbl.text = ti[indexPath.row]
        ...
        if data != nil
        {
            cell.timg.image =  UIImage(data:data as! Data)
        }
    ...
    @IBOutlet weak var technology: UITableView!
...
POST_Data()
    ...
    {
        //Make ADDRESS URL
        let reqUrl = URL(string: "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=68837ddffe7343d69a232fba9e7fc178")
